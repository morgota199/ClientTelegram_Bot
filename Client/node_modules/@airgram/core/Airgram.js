...
var Airgram = /** @class */ (function () {
    ...
    Airgram.prototype.destroy = function () {
        return this.provider.destroy();
    };
    Airgram.prototype.emit = function (update, state) {
    ...
    Airgram.prototype.apiMiddleware = function () {
        ...
        return components_1.Composer.optional(function (ctx) { return !!ctx.request; }, function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.provider.send(ctx.request)
    ...
    Airgram.prototype.handleUpdate = function (update, state) {
        var _this = this;
